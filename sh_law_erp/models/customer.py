# -*- coding: utf-8 -*-
#185.205.246.145/rootpwd:fda#2020@2020
...
class ResPartner(models.Model):
    ...
    evidence_count = fields.Integer(
        "Documents", compute="_compute_compute_evidence_count")
    trial_count = fields.Integer("Trial", compute="_compute_compute_trial_count")
    capt = fields.Float("Company Capital")
    trm = fields.Char(string="Chamber of Commerce Membership")
    ei = fields.Char(string="Register of exporters and suppliers")
    bn = fields.Char(string="Brad Name")
    ca = fields.Char(string="Commercial Agency")
    b_n = fields.Char(strig="Business Names")
